...
if (!empty($_GET['q'])){
	$sql="SELECT * FROM init_test WHERE lot_no = '".$q."' ORDER BY id DESC LIMIT 1 ";
	...
	if ($result->num_rows > 0) {
		...
		<tr>
			...
			<td class='td2'>
		<input type='text' id='mlot' name='mlot' onkeypress='return isNumberKey(event)' value='$row[mother_lot]' style='background-color: #e1e1e1;' readonly/>
			</td>
		</tr>
		<tr>
		...
		<td id='ngstyle' class='td2'><input name='test' onclick='showfield2()' type='radio' value='R' checked>NG RETEST</td>
		...
		<tr>
			...
			<td class='td2'>
				<input class='txtInput' id='txtInput2' type = 'text' name='lotnumber' onblur='query()' onkeypress='return isNumberKey(event)' maxlength='10' style='width: 180px; color: red;' placeholder='NO INITIAL TEST YET' readonly />
				<input id='subquery' type='submit' value='submit' style='display: none;'/>
			</td>
			<td class='td2'>
				Process name:
		...
		<tr>
			...
			<td class='td2'>
				<input tabindex='4' type='text' id='ttlqty' name='ttlqty' onkeypress='return isNumberKey(event)' maxlength='10' style='width: 180px;' readonly />
			</td>
			<td class='td2'>
				Tester no.:
			</td>
		...
		<tr>
			...
			<td class='td2'>
				<input tabindex='6' id='plteno' type='text' name='plteno' style='width: 180px;' maxlength='5' readonly />
			</td>
			<td class='td2'>
				Handler no.:
			</td>
